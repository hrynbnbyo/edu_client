      ...
      <div class="cart_info">
        ...
        <div class="cart_table">
          ...
          <div class="cart_course_list">
            <CartItem v-for="(course,index) in cart_list" :key="index" :course="course" @change_selected="cart_total" @del_item="get_cart_list"></CartItem>
          </div>
    ...
    methods:{
        ...
        get_cart_list() {
            ...
            this.$axios.get(this.$settings.HOST + "cart/option/", {
                ...
                // this.check_cart_length()
                if(this.cart_list.length===0){
                    this.$confirm("请添加商品后再使用购物车",{
                    callback(){
